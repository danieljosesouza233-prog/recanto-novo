...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Instituto do Amor — Campanha de Arrecadação" },
      { name: "description", content: "Ajude uma família a recomeçar. Doe agora para a campanha verificada do Instituto do Amor." },
      { name: "author", content: "Instituto do Amor" },
      { property: "og:title", content: "Instituto do Amor — Campanha de Arrecadação" },
      { property: "og:description", content: "Ajude uma família a recomeçar. Doe agora para a campanha verificada do Instituto do Amor." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Instituto do Amor — Campanha de Arrecadação" },
      { name: "twitter:description", content: "Ajude uma família a recomeçar. Doe agora para a campanha verificada do Instituto do Amor." },
